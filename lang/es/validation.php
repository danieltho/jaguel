...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Mensajes de error de validación en español. Las claves :attribute,
    | :value, etc. son reemplazadas por el validador de Laravel.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Mensajes personalizados por campo y regla específica.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Nombres legibles en español para cada campo, usados en los mensajes.
    |
    */
