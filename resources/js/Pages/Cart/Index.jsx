    ...
    return (
        <div className="flex items-start gap-3 py-4 sm:items-center sm:gap-4">
            <Link href={`/producto/${item.slug}`} className="shrink-0">
                <div className="h-20 w-20 overflow-hidden rounded-xl bg-neutral-100 sm:h-[100px] sm:w-[100px]">
                    <img
        ...
        <Template>
            ...
            <div className="mx-auto max-w-[1320px] px-4 py-6 sm:px-8 lg:px-15">
                ...
                <div className="flex flex-col items-start gap-6 lg:flex-row">
                    <div className="w-full flex-1 divide-y divide-neutral-200 rounded-2xl bg-white p-4 sm:p-6">
                        {items.map((item) => (
                            <CartItem key={item.cart_key} item={item} />
                        ))}
                    </div>

                    <div className="w-full shrink-0 lg:w-[424px]">
